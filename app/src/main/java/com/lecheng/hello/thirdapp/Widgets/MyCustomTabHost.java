 ...
 */
public class MyCustomTabHost extends TabHost implements
    ...
    public MyCustomTabHost(Context context) {
    ...
    public MyCustomTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
