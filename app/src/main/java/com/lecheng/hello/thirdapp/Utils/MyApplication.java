...
//        crashHandler.init(getApplicationContext());//异常捕获类单例
    ...
    private DisplayImageOptions getDisplayOptions() {
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.color.gray1) // 设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.color.gray1)// 设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.color.gray1) // 设置图片加载/解码过程中错误时候显示的图片
