...
public class Aty030VideoView extends Activity implements MediaPlayer.OnErrorListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = (EditText) findViewById(R.id.testurl);
        mButton = (Button) findViewById(R.id.openurl);
